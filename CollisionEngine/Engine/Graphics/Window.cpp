...
bool Window::OnCreate(std::string name_, int width_, int height_) {
	...
	Debug::Print("Graphics card: " + std::string(reinterpret_cast<const char*>(glGetString(GL_RENDERER))));
	Debug::Print("OpenGL version: " + std::string(reinterpret_cast<const char*>(glGetString(GL_VERSION))));
